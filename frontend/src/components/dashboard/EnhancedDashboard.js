      ...
      >
        <Box sx={{ position: 'relative', zIndex: 1 }}>
          ...
          <Box sx={{ display: 'flex', gap: 2 }}>
            <Button
              variant="contained"
              sx={{ bgcolor: 'white', color: '#1E3A8A', '&:hover': { bgcolor: 'rgba(255,255,255,0.9)' } }}
            ...
            <CardContent>
              ...
              <ResponsiveContainer width="100%" height={280}>
                <LineChart data={revenueData}>
                  ...
                  <YAxis stroke="#999" />
                  <RechartsTooltip />
                  <Line type="monotone" dataKey="revenue" stroke="#1E40AF" strokeWidth={3} dot={{ r: 6 }} />
                ...
                <Box key={index} sx={{ display: 'flex', alignItems: 'flex-start', mb: 2, p: 2, borderRadius: 2, bgcolor: 'background.default' }}>
                  <Box
                    sx={{
                      ...
                      color: activity.status === 'success' ? '#2e7d32' : activity.status === 'warning' ? '#ed6c02' : '#1E40AF',
                      mr: 2,
                    }}
                  >
