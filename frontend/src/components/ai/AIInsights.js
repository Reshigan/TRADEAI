      ...
      if (insightFilters.priority) {
        params.append('priority', insightFilters.priority);
          ...
          recommendations: [
            ...
            'Expand marketing budget for trending categories',
            'Prepare for continued growth trajectory'
          ]
        },
        {
          id: 'insight_2',
          ...
          summary: 'Significant shift in customer purchasing patterns detected. Mobile app usage increased 34% while desktop purchases decreased 12%.',
          priority: 'high',
          confidence: 0.92,
          impact: 'high',
          urgency: 'high',
          ...
          recommendations: [
            ...
            'Review desktop user experience'
          ]
        },
        {
          id: 'insight_3',
          ...
          summary: 'Current promotions showing mixed results. "Summer Sale" exceeding targets by 23% while "Flash Friday" underperforming by 18%.',
          priority: 'medium',
          confidence: 0.87,
          impact: 'medium',
          urgency: 'high',
          ...
          data: {
            performance: {
              topPerforming: ['Summer Sale', 'Back to School'],
              underperforming: ['Flash Friday', 'Weekend Special'],
              avgROI: 156
            }
          },
          recommendations: [
            'Extend Summer Sale duration',
            'Revise Flash Friday strategy',
            'Analyze Weekend Special targeting'
          ]
        },
        {
          id: 'insight_4',
          ...
          summary: '127 customers identified as high churn risk, representing potential revenue loss of R285,000.',
          priority: 'high',
          confidence: 0.91,
          impact: 'high',
          urgency: 'high',
          ...
          data: {
            churnRisk: {
              highRiskCustomers: 127,
              potentialRevenueLoss: 285000,
              topRiskFactors: ['Decreased engagement', 'Support tickets', 'Price sensitivity']
            }
          },
          recommendations: [
        ...
        },
        {
          ...
          summary: 'Emerging demand detected in "Smart Home" category with 45% growth potential and low competition.',
          priority: 'medium',
          confidence: 0.78,
          impact: 'high',
          urgency: 'low',
          ...
          recommendations: [
            'Research Smart Home product lines',
