...
const CreateClaim = () => {
  ...
  const updateLineItem = (index, field, value) => {
    ...
    setFormData(prev => ({
      ...
      claimAmount: updatedLineItems.reduce((sum, item) => sum + (item.claimAmount || 0), 0)
    }));
  };
          ...
          <Card>
            <CardContent>
              ...
              {formData.lineItems.length === 0 ? (
                <Alert severity="info">
                  No line items added. Click "Add Line Item" to add products to this claim.
                </Alert>
              ) : (
                        ...
                        <TableRow key={index}>
                          ...
                          <TableCell>
                            <TextField
                              ...
                              onChange={(e) => updateLineItem(index, 'claimRate', parseFloat(e.target.value) || 0)}
                              sx={{ width: 80 }}
                            />
                          </TableCell>
                          <TableCell>
            ...
            <CardContent>
              ...
              <Box sx={{ mb: 3 }}>
                ...
                <Typography variant="h4" color="primary">
                  {formData.currency} {formData.claimAmount.toFixed(2)}
                </Typography>
              </Box>
              <Box sx={{ mb: 2 }}>
                <Typography variant="body2" color="textSecondary">
